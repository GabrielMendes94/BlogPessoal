...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT) //caso a porta 8080 esteja ocupada, uma outra porta aleatória é utilizada
...
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) //indica que os testes serão executados na ordem indicada
